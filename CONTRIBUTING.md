...
Then you can create a Pull Request at [f2native](https://github.com/antvis/f2native/pulls).
...
4. User Tips: Notice for f2native users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
```
fix($compile): [BREAKING_CHANGE] couple of unit tests for iOS14

Older OS serialize html uppercased, but iOS14 does not...
Would be better to expect case insensitive, unfortunately jasmine does
not allow to user regexps for throw expectations.

Document change on antvis/f2native#123
...
f2native uses semantic versioning in release process based on [semver].
