...
class AbstractGeom {
  public:
    ...
    void Paint(XChart *chart, Group *container);
  ...
  protected:
    AbstractGeom(utils::Tracer *tracer) : tracker_(tracer){};
    // 数据分组
    ...
    virtual void Draw(XChart &chart, Group &container, const nlohmann::json &groupData) const;
