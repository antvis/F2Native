/**
 *  wasi的canvas, 通过把canvas注入到wasi容器中
 */
...
#ifndef XG_GRAPHICS_CANVAS_CONTEXT_WASI_H
#define XG_GRAPHICS_CANVAS_CONTEXT_WASI_H

namespace xg {
namespace canvas {

class WasiCanvasContext : public CanvasContext {
  public:
  ...
  public:
    WasiCanvasContext(const std::string &contextName, float width, float height, double devicePixelRatio);
    ~WasiCanvasContext();
...
#endif // XG_GRAPHICS_CANVAS_CONTEXT_WASI_H
