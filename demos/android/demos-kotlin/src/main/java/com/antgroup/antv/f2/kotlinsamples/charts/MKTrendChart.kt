                    ...
                    AxisLabelConfigBuilder().labelMargin(20f).labelOffset(4f).textColor("#999999")
                        .item(mChart, object : F2Function() {
                            override fun execute(param: String): F2Config {
                                ...
                                return if (index == 0) {
                                    F2Config.Builder<F2Config.Builder<*>>().setOption("content", "09:30").build()
                                } else if (index == 1) {
                                    F2Config.Builder<F2Config.Builder<*>>().setOption("content", "11:30/13:00")
                                        .build()
                                } else if (index == 2) {
                                    F2Config.Builder<F2Config.Builder<*>>().setOption("content", "15:00").build()
                                } else {
                                    F2Config.Builder<F2Config.Builder<*>>().setOption("content", "").build()
                                }
                            }
                        })
                )
